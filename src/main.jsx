...
import { analysisUtilityRuntime, utilityRuntime } from './three/runtime.js';
...
import { RenamePointModal, SaveArchiveModal, UtilityNoteModal } from './components/WorkspaceModals.jsx';
...
function App() {
  ...
  return <main className={`board-shell${isMobile ? ' is-mobile' : ''}${!hasLeftSidebar || !leftSidebarOpen ? ' left-sidebar-collapsed' : ''}${hasRightSidebar && !rightSidebarOpen ? ' right-sidebar-collapsed' : ''}`} data-panel={activePanel} data-analysis-metric={demoViewFlags.analysisMetric}>
    ...
    <section className="board-stage">
      ...
      {saveArchiveModal && <SaveArchiveModal archives={archives} draftName={saveArchiveName} language={language} mapName={mapName} onClose={() => setSaveArchiveModal(false)} onDraftNameChange={setSaveArchiveName} onSave={saveWorkspaceArchive} onSelectedChange={setSaveArchiveSelected} selected={saveArchiveSelected} t={t} />}
