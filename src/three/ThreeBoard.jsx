...
import { createFireNavEffect, createGrenadeEffect, disposeGrenadeEffect, grenadeTypeFromPointer } from './grenadeEffects.js';
...
export default function ThreeBoard(props) {
  ...
  const {
    ...
    demoProjectilesRef, demoSmokeVoxelFramesRef, demoGrenadeSegmentsRef, demoGrenadeSelectRef, demoDeathsRef,
  ...
  useEffect(() => {
    ...
    const getWorkspaceState = ({ includeDemo = false } = {}) => {
      ...
      return { cameraSlots: cameraState.serializeSlots(), camera: getCameraState(), points, paths: [], grenades, collabUtilities: collabUtilityScene.serialize(), brushStrokes: brushStrokes.map((line) => serializeBrushLine(line)) };
    };
