...
Release 1.15.1 retains GPL-3.0-only for CSBoard; the standard GPL text in `LICENSE` is unchanged. Corresponding source for distributed modified parser builds includes the upstream revision and local patches documented in `src/wasm/README.md`.
